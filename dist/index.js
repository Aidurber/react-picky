...
function arrayPush(array$$1, values) {
  ...
  while (++index < length) {
    array$$1[offset + index] = values[index];
  }
  return array$$1;
}
  ...
  while (++index < arrLength) {
    ...
    if (customizer) {
      var compared = isPartial
        ? customizer(othValue, arrValue, index, other, array$$1, stack)
        : customizer(arrValue, othValue, index, array$$1, other, stack);
    }
...
function toSource(func$$1) {
  if (func$$1 != null) {
    try {
      return funcToString.call(func$$1);
    } catch (e) {}
    try {
      return (func$$1 + '');
    } catch (e) {}
