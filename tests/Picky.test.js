...
describe('Picky', () => {
  ...
  describe('Placeholder', () => {
    it('should show placeholder if no initial values', () => {
      const wrapper = shallow(<Picky placeholder="No selected values" />);
